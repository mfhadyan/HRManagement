...
<div class="container-fluid mt-2 px-4">
  <div class="row">
    <div class="col-12">
        <h4 class="font-weight-bold">Edit Announcement</h4>
        <hr>
    </div>
  </div>
    ...
    <div class="col-12 mb-3">
      <div class="bg-light text-dark card p-3 overflow-auto">
        ...
        <div class="d-flex justify-content-between mb-3">
          <h6 class="mb-0">Edit Announcement</h6>
          <a href="{{ route('announcements.show', $announcement) }}" class="btn btn-secondary btn-sm">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Enter announcement title" value="{{ old('title', $announcement->title) }}" required>
                @error('title')
              ...
              <div class="form-group">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="8" placeholder="Enter announcement description" required>{{ old('description', $announcement->description) }}</textarea>
                @error('description')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                @if($announcement->attachment)
                  <div class="mt-2">
                    ...
                    <br>
                    <a href="{{ asset('/storage/' . $announcement->attachment) }}" target="_blank" class="btn btn-sm btn-outline-info">
